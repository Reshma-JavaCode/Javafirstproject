...
public class GoldLoan extends LoanImp {

	public static void main(String[] args) {

		System.out.println("********Welcome to RMR Bank for Gold Loan*******");
		GoldLoan l = new GoldLoan();

		if (l.validateCustomer()) {
			Customer customer = l.getCustomerDetails();

			if ((customer.getAge() > 22 && customer.getAge() <= 75) && (customer.getSalary() >= 25000)
