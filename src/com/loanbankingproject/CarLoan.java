...
public class CarLoan extends LoanImp {

	public static void main(String[] args) {

		System.out.println("********Welcome to RMR Bank for Car Loan*******");
		CarLoan l = new CarLoan();

		if (l.validateCustomer()) {
			Customer customer = l.getCustomerDetails();

			if ((customer.getAge() > 20 && customer.getAge() <= 70) && (customer.getSalary() >= 20000)
